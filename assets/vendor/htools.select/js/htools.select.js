...
(function ($) {
    $.fn.extend({
        "goSelectInput": function (parms) {
            ...
            //开始加载代码
            var beforeHtml = '<div class="_htools-select" style="height: ' + conf.height + 'px;line-height: ' + (conf.height-3) + 'px;width: ' + conf.width + 'px;" onclick="htools.select.doSelect(\'' + uuid + '\');">';
            beforeHtml += '<div id="_select-input_' + uuid + '" class="_select-input" style="height: ' + conf.height + 'px; width: ' + (conf.width - 25) + 'px;">';

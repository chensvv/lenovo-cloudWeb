...
(function (global) {
    ...
    var req, s, head, baseElement, dataMain, src, interactiveScript, currentlyAddingScript, mainScript, subPath,
        version = "2.1.16", commentRegExp = /(\/\*([\s\S]*?)\*\/|([^:]|^)\/\/(.*)$)/mg,
    ...
    function I(e, n, r, i) {
        if (b.acceptData(e)) {
            var s, o, u = b.expando, a = "string" == typeof n, f = e.nodeType, c = f ? b.cache : e,
                h = f ? e[u] : e[u] && u;
    ...
    function un(e, t, n) {
        var r = !0, i = "width" === t ? e.offsetWidth : e.offsetHeight, s = qt(e),
    ...
    var n, r, i = typeof t, s = e.document, o = e.location, u = e.jQuery, a = e.$, f = {}, l = [], c = "1.9.1",
        h = l.concat, p = l.push, d = l.slice, v = l.indexOf, m = f.toString, g = f.hasOwnProperty, y = c.trim,
        b = function (e, t) {
            return new b.fn.init(e, t, r)
        }, w = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, E = /\S+/g, S = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
        x = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, T = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, N = /^[\],:{}\s]*$/,
        C = /(?:^|:|,)(?:\s*\[)+/g, k = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,
        L = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, A = /^-ms-/, O = /-([\da-z])/gi,
        M = function (e, t) {
    ...
    b.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            var t = 0, n = d.call(arguments), r = n.length, i = 1 !== r || e && b.isFunction(e.promise) ? r : 0,
                s = 1 === i ? e : b.Deferred(), o = function (e, t, n) {
                    return function (r) {
    ...
    var z, W, X = /[\t\r\n]/g, V = /\r/g, $ = /^(?:input|select|textarea|button|object)$/i, J = /^(?:a|area)$/i,
        K = /^(?:checked|selected|autofocus|autoplay|async|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped)$/i,
        Q = /^(?:checked|selected)$/i, G = b.support.getSetAttribute, Y = b.support.input;
    b.fn.extend({
        attr: function (e, t) {
    ...
    b.event = {
        ...
        trigger: function (n, r, i, o) {
            var u, a, f, l, c, h, p, d = [i || s], v = g.call(n, "type") ? n.type : n,
        ...
        dispatch: function (e) {
            e = b.event.fix(e);
            var n, r, i, s, o, u = [], a = d.call(arguments), f = (b._data(this, "events") || {})[e.type] || [],
        ...
        function gt(e, t, n, r, i, s) {
            return r && !r[w] && (r = gt(r)), i && !i[w] && (i = gt(i, s)), st(function (s, o, u, a) {
                var f, l, c, h = [], p = [], d = o.length, v = s || wt(t || "*", u.nodeType ? [u] : u, []),
                    m = !e || !s && t ? v : mt(v, h, e, u, a), g = n ? i || (s ? e : d || r) ? [] : o : m;
                if (n && n(m, g, u, a), r) {
        ...
        function bt(e, t) {
            var n = 0, s = t.length > 0, o = e.length > 0, u = function (u, a, l, h, p) {
                var d, v, m, g = [], y = 0, b = "0", w = u && [], E = null != p, S = f,
                    T = u || o && i.find.TAG("*", p && a.parentNode || a), N = x += null == S ? 1 : Math.random() || .1;
        ...
        var n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, w = "sizzle" + -(new Date), E = e.document, S = {},
            x = 0, T = 0, N = it(), C = it(), k = it(), L = typeof t, A = 1 << 31, O = [], M = O.pop, _ = O.push,
            D = O.slice, P = O.indexOf || function (e) {
                    var t = 0, n = this.length;
                    for (; n > t; t++)if (this[t] === e)return t;
                    return -1
                }, H = "[\\x20\\t\\r\\n\\f]", B = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+", j = B.replace("w", "w#"),
            F = "([*^$|!~]?=)",
            I = "\\[" + H + "*(" + B + ")" + H + "*(?:" + F + H + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + j + ")|)|)" + H + "*\\]",
            q = ":(" + B + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + I.replace(3, 8) + ")*)|.*)\\)|)",
            R = RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$", "g"), U = RegExp("^" + H + "*," + H + "*"),
            ...
            }, $ = /[\x20\t\r\n\f]*[+~]/, J = /^[^{]+\{\s*\[native code/, K = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
            Q = /^(?:input|select|textarea|button)$/i, G = /^h\d$/i, Y = /'|\\/g,
    ...
    var ot = /Until$/, ut = /^(?:parents|prev(?:Until|All))/, at = /^.[^:#\[\.,]*$/, ft = b.expr.match.needsContext,
    ...
    var dt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        vt = / jQuery\d+="(?:null|\d+)"/g, mt = RegExp("<(?:" + dt + ")[\\s/>]", "i"), gt = /^\s+/,
    ...
    var It, qt, Rt, Ut = /alpha\([^)]*\)/i, zt = /opacity\s*=\s*([^)]*)/, Wt = /^(top|right|bottom|left)$/,
        Xt = /^(none|table(?!-c[ea]).+)/, Vt = /^margin/, $t = RegExp("^(" + w + ")(.*)$", "i"),
        Jt = RegExp("^(" + w + ")(?!px)[a-z%]+$", "i"), Kt = RegExp("^([+-])=(" + w + ")", "i"), Qt = {BODY: "block"},
        Gt = {position: "absolute", visibility: "hidden", display: "block"}, Yt = {letterSpacing: 0, fontWeight: 400},
    ...
    var mn, gn, yn = b.now(), bn = /\?/, wn = /#.*$/, En = /([?&])_=[^&]*/, Sn = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        ...
        Cn = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, kn = b.fn.load, Ln = {}, An = {}, On = "*/".concat("*");
    try {
        gn = o.href
    } catch (Mn) {
    ...
    mn = Cn.exec(gn.toLowerCase()) || [], b.fn.load = function (e, n, r) {
        ...
        ajax: function (e, n) {
            ...
            var r, i, s, o, u, a, f, l, c = b.ajaxSetup({}, n), h = c.context || c,
                p = c.context && (h.nodeType || h.jquery) ? b(h) : b.event, d = b.Deferred(),
                v = b.Callbacks("once memory"), m = c.statusCode || {}, g = {}, y = {}, w = 0, S = "canceled", x = {
    ...
    b.ajaxSetup({
        ...
        var s, o, u,
            a = n.jsonp !== !1 && (Fn.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && Fn.test(n.data) && "data");
    ...
    var Xn, Vn, $n = /^(?:toggle|show|hide)$/, Jn = RegExp("^(?:([+-])=|)(" + w + ")([a-z%]*)$", "i"),
    ...
    b.Animation = b.extend(er, {
        ...
        fadeTo: function (e, t, n, r) {
            ...
            return e !== !1 && (e = e || "fx"), this.each(function () {
                var t, n = b._data(this), r = n[e + "queue"], i = n[e + "queueHooks"], s = b.timers,
                    o = r ? r.length : 0;
        ...
        setOffset: function (e, t, n) {
            ...
            var i = b(e), s = i.offset(), o = b.css(e, "top"), u = b.css(e, "left"),
                a = ("absolute" === r || "fixed" === r) && b.inArray("auto", [o, u]) > -1, f = {}, l = {}, c, h;
...
+function (e) {
    ...
    n.VERSION = "3.3.4", n.TRANSITION_DURATION = 600, n.DEFAULTS = {
        ...
        var i = this.$element.find(".item.active"), s = r || this.getItemForDirection(t, i), o = this.interval,
            u = "next" == t ? "left" : "right", f = this;
        if (s.hasClass("active"))return this.sliding = !1;
        var l = s[0], h = e.Event("slide.bs.carousel", {relatedTarget: l, direction: u});
        if (this.$element.trigger(h), !h.isDefaultPrevented()) {
            ...
            var d = e.Event("slid.bs.carousel", {relatedTarget: l, direction: u});
    ...
    o.VERSION = "3.3.4", o.prototype.toggle = function (r) {
        ...
        if (/(38|40|27|32)/.test(t.which) && !/input|textarea/i.test(t.target.tagName)) {
            ...
            if (t.preventDefault(), t.stopPropagation(), !r.is(".disabled, :disabled")) {
                ...
                if (!o && 27 != t.which || o && 27 == t.which)return 27 == t.which && i.find(s).trigger("focus"), r.trigger("click");
    ...
    n.VERSION = "3.3.4", n.TRANSITION_DURATION = 150, n.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (l) {
                var v = u, m = this.options.container ? e(this.options.container) : this.$element.parent(),
        ...
        var h = /top|bottom/.test(n), p = h ? 2 * c.left - i + f : 2 * c.top - s + l,
    ...
    n.VERSION = "3.3.4", n.TRANSITION_DURATION = 150, n.prototype.show = function () {
        ...
        if (r || (r = t.attr("href"), r = r && r.replace(/.*(?=#[^\s]*$)/, "")), !t.parent("li").hasClass("active")) {
            var i = n.find(".active:last a"), s = e.Event("hide.bs.tab", {relatedTarget: t[0]}),
    ...
    n.VERSION = "3.3.4", n.RESET = "affix affix-top affix-bottom", n.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            var t = this.$element.height(), r = this.options.offset, i = r.top, s = r.bottom,
    ...
    e.fn.dropdownHover = function (n) {
        return r = r.add(this.parent()), this.each(function () {
            var n = e(this).parent(), i = {delay: 100, instantlyCloseOthers: !0},
                s = {delay: e(this).data("delay"), instantlyCloseOthers: e(this).data("close-others")},
    ...
    paths: {
        ...
        zn: "http://zhannei.baidu.com/api/customsearch/apiaccept?sid=1165873533454276217&v=2.0"
    },
    shim: {zn: {exports: "BCse"}}
    ...
    return window.USER_LOG = {
        send: function (e) {
            ...
            $.ajax({
                url: t + "?t=" + (new Date - 0), type: e.type || "get", cache: !1, data: e.data, success: function (e) {
                }
            })
        }
    }, $("body").on("click", "[data-user-log]", function () {
        var e = $(this).attr("data-user-log");
        e && window.USER_LOG.send({type: "post", data: {keyWord: e}})
    }), window.USER_LOG
}), define("common/widget/fixedzone/fixedzone", ["require"], function (e) {
    function t(e) {
        this.obj = e, this.hasOtherBtn = !1
    }

    return $.extend(t.prototype, {
        init: function () {
            this.createElement(), this.setElePosition(), this.backToTopToggle(), this.backToTop(), this.resizeSetElePosition()
        }, createElement: function () {
            var e = $("#eui-fixed-zone"), t = '<a class="eui-back-to-top" href="javascript:void(0)">回顶部</a>';
            $(".eui-back-to-top").remove();
            if (e.length) $(t).appendTo(e), this.hasOtherBtn = !0; else {
                var n = '<div id="eui-fixed-zone">' + t + "</div>";
                $(n).appendTo($("body"))
            }
            this.toTopWidth = $(".eui-back-to-top").width()
        }, setElePosition: function () {
            var e = ($(window).width() - this.obj.oWrapper.width()) / 2 - this.toTopWidth - 2;
            e = e > 0 ? e : 0, $("#eui-fixed-zone").css("right", e)
        }, backToTopToggle: function () {
            var e = this.addOtherBtn(), t = this;
            $(window).on("scroll", function () {
                $(document).scrollTop() > 100 ? (e.data("setPosition") || (t.setElePosition(), e.data("setPosition", !0)), e.show()) : e.hide()
            })
        }, addOtherBtn: function () {
            var e = $(".eui-back-to-top");
            return this.hasOtherBtn && e.siblings().each(function (t, n) {
                $(n).css("display") === "none" && (e = e.add($(n)))
            }), e
        }, backToTop: function () {
            $(".eui-back-to-top").on("click", function () {
                $("html, body").animate({scrollTop: 0}, 200)
            })
        }, resizeSetElePosition: function () {
            var e = this;
    ...
    e.extend(e.fn, {
        validate: function (t) {
            ...
            var a = e.validator.normalizeRules(e.extend({}, e.validator.metadataRules(r), e.validator.classRules(r), e.validator.staticRules(r)), r);
            if (a.required) {
                var f = a.required;
        ...
        prototype: {
            init: function () {
                ...
                }), e(this.currentForm).validateDelegate(":text, :password, :file, select, textarea", "focusin focusout keyup", r).validateDelegate(":radio, :checkbox, select, option", "click", r), this.settings.invalidHandler && e(this.currentForm).bind("invalid-form.validate", this.settings.invalidHandler)
            }, form: function () {
                ...
                if (this.settings.unhighlight)for (var e = 0,
                                                       n = this.validElements(); n[e]; e++)this.settings.unhighlight.call(this, n[e], this.settings.errorClass, this.settings.validClass);
        ...
        staticRules: function (t) {
            ...
            return r && (n = e.validator.normalizeRule(r.settings.rules[t.name]) || {}), n
        },
    ...
    function n(e) {
        ...
        var t = {
            title: "提示", content: "", mask: !0, destroyWhenClose: !1, callback: function () {
            }
        };
    ...
    return t.showMask = function () {
        ...
        bindEvent: function () {
            ...
            this._self && (this._opt.destroyWhenClose ? this._self.remove() : this._self.hide()), this._opt.mask && t.hideMask();
            if (this._opt.callback)if (e) {
                var n = e.attr("data-type") === "yes" ? !0 : !1;
                this._opt.callback(n)
            } else this._opt.callback()
        }
    }), t.dialog = function (e) {
        return new n(e)
    }, t.alert = function (e) {
        ...
        e = e || {}, e.type = e.type || "default", e.time = e.time || 2e3, e.mask = !1, e.destroyWhenClose = !0;
        var t = e.content || "";
...
}), define("core/widget/consultDialog/consultDialog", ["require", "jquery.validate", "common/widget/dialog/dialog"], function (e) {
    function r(e) {
        this._createLink = $("#j-create-app-link"), this._selectLink = $("#j-select-app-link"), this.init()
    }

    e("jquery.validate");
    var t = e("common/widget/dialog/dialog"),
        n = '        <div class="consult-dialog-content">            <section class="consult-modal-content">                <form class="consult-form" method="post" action="/contact/sendEmail">                    <input class="consult-form-input" type="text" placeholder="请输入您的公司/单位名称（必填）" name="companyName">                    <input class="consult-form-input" type="text" placeholder="请输入您的姓名/称呼（必填）" name="name">                    <input class="consult-form-input" type="text" placeholder="请输入您的联系电话：手机/固定电话（必填）" name="phone">                    <input class="consult-form-input" type="text" placeholder="请输入您的邮箱地址（必填）" name="email">                    <input class="consult-form-input" type="text" placeholder="请输入您的行业（选填）" name="trade">                    <input class="consult-form-input" type="text" placeholder="请输入您的公司/单位网址（必填）" name="siteUrl">                    <textarea class="consult-form-input consult-form-textarea"                        placeholder="您的公司的业务简要介绍限300字（必填）" maxlength="300" name="business"></textarea>                    <textarea class="consult-form-input consult-form-textarea"                         placeholder="您对语音的需求介绍限300字（必填）" maxlength="300" name="requirement"></textarea>                    <div class="qr-code-input">                        <input class="consult-form-input" type="text" placeholder="请输入正确的验证码" name="code">                        <a>                            <img alt="点击刷新验证码">                        </a>                    </div>                    <div class="info-warning"></div>                    <div class="form-actions">                        <button type="submit" class="btn-primary submit">提交需求</button>                        <button data-action="close" type="button" class="btn-default">取消</button>                    </div>                </form>            </section>        </div>';
    return $.extend(r.prototype, {
        init: function () {
            ...
            this._dialog = t.dialog({
                title: "合作咨询", content: n, destroyWhenClose: !0, ready: function (t) {
                    t.find(".eui-dialog-title").css("margin-left", "170px"), e._root = $(".consult-dialog-content"), e._form = e._root.find(".consult-form"), e.bindDialogEvent(), e.refreshCode()
                }
            }), this._dialog.show()
        }, submitForm: function () {
            var e = this;
            $.ajax({
                ...
                t.result === "success" ? e.onSubmitSuccess() : e.onSubmitFail(t.msg)
            }).fail(function () {
                e.onSubmitFail()
            })
        }, onSubmitSuccess: function () {
            this._dialog.hide(), t.tip({content: "提交成功", type: "success", time: 2e3}).show()
        }, onSubmitFail: function (e) {
            this.refreshCode(), t.tip({content: e || "服务器出错了", type: "error"}).show()
        }, refreshCode: function () {
            this._root.find(".qr-code-input img").attr("src", "/contact/captcha.jpg?v=" + Date.now())
        }, bindEvent: function () {
            var e = this;
            $("#eui-main-footer .consult-email-btn").on("click", function () {
                e.openDialog()
            })
            ...
            this._form.validate({
                rules: {
                    companyName: {required: !0, maxlength: 100},
                    name: {required: !0, maxlength: 60},
                    phone: {required: !0, maxlength: 16},
                    email: {required: !0, maxlength: 100, email: !0},
                    trade: {required: !0, maxlength: 100},
                    siteUrl: {required: !0, maxlength: 100},
                    business: {required: !0, maxlength: 300},
                    requirement: {required: !0, maxlength: 300},
                    code: {required: !0}
                },
                messages: {
                    companyName: {required: "请输入公司/单位名称", maxlength: "最多输入100个字"},
                    name: {required: "请输入姓名/称呼", maxlength: "最多输入60个字"},
                    phone: {required: "请输入电话/固定电话", maxlength: "最多输入16个字"},
                    email: {required: "请输入邮箱地址", maxlength: "最多输入100个字", email: "请输入正确的邮箱地址"},
                    trade: {required: "请输入行业", maxlength: "最多输入100个字"},
                    siteUrl: {required: "请输入公司/单位地址", maxlength: "最多输入100个字"},
                    business: {required: "请输入业务简要", maxlength: "最多输入300个字"},
                    requirement: {required: "请输入需求介绍", maxlength: "最多输入300个字"},
                    code: {required: "请输入验证码"}
                },
                submitHandler: function (t) {
                    return e.submitForm(), !1
                }
            }), $(".qr-code-input img").on("click", function () {
                e.refreshCode()
            })
        }
    }), r
}), require(["common/widget/loginpop/loginpop", "common/widget/userlog/userlog", "common/widget/fixedzone/fixedzone", "core/widget/consultDialog/consultDialog"], function (e, t, n, r) {
    $("#j-login").on("click", function () {
        (new e({goUrl: window.location.href})).init(), window.LoginPop.show()
    }), $(".wakeinput").focus(function () {
        var t = window.$CONFIG["logging.status"];
        t || ((new e({goUrl: window.$CONFIG["paths.base"] + "wake"})).init(), window.LoginPop.show())
    }), $("[data-app-management=true]").on("click", function () {
        var t = window.$CONFIG["logging.status"], n = window.$CONFIG["paths.base"] + "app";
        t ? window.location.href = n : ((new e({goUrl: n})).init(), window.LoginPop.show())
    }), $(document).on("click", "[data-login-check=true]", function () {
        var t = window.$CONFIG["logging.status"];
        t || ((new e({goUrl: window.location.href})).init(), window.LoginPop.show())
    }), (new n({oWrapper: $(".container")})).init(), $("[qa-search=true]").on("click", function () {
        var e = $(".searchkw").val();
        e !== "可以搜索：可以动态设置垂直类别吗？" && e !== "" && (window.location.href = window.$CONFIG["paths.base"] + "bbs/question/search?q=" + encodeURIComponent(e))
    }), $(".searchkw").bind("keypress", function (e) {
        if (e.keyCode === 13) {
            var t = $(".searchkw").val();
            t !== "可以搜索：可以动态设置垂直类别吗？" && t !== "" && (window.location.href = window.$CONFIG["paths.base"] + "bbs/question/search?q=" + encodeURIComponent(t))
        }
    }), $(".searchkw").bind("click", function () {
        $(".searchkw").val("")
    }), $(".searchkw").bind("focusout", function () {
        $(".searchkw").attr("t") !== "false" && $(".searchkw").val("可以搜索：可以动态设置垂直类别吗？")
    }), $("#oldversionbtn").on("click", function () {
        $("#oldversion").show(), $(".showold").addClass("cur")
    }), $("#sdkmask").on("click", function () {
        $("html, body").animate({scrollTop: 0}, 200)
    }), $("#newsdk").on("click", function () {
        $.get(window.$CONFIG["paths.base"] + "resources/online/product/img/wake-btn.jpg?newsdk=1&t=" + Date.parse(new Date))
    }), new r
